...
> Runs entirely **offline**, directly on your Mac — no API keys, no cost, full control.
...
The chatbot is built with **Python**, **Streamlit**, and **Ollama**, providing a real-time conversational UI similar to ChatGPT — but everything runs on your machine.

---

## 🚀 Features

- 🧩 **Local inference** with `llama3`, `mistral`, or any Ollama-compatible model  
- ⚡ **Instant setup** — no API keys, no billing, no internet required  
- 🧠 **Conversational memory** within the chat session  
